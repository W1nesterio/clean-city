...
<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh;text-align:center;padding:48px 24px;">
    <div style="font-size:72px;font-weight:900;color:var(--primary-soft);letter-spacing:-.04em;line-height:1;">403</div>
    <h1 style="margin:16px 0 8px;font-size:28px;font-weight:700;letter-spacing:-.02em;color:var(--text);">Доступ запрещён</h1>
    <p style="color:var(--muted);max-width:400px;line-height:1.6;margin:0 0 28px;">
        {{ $exception->getMessage() ?: 'У вас нет прав для просмотра этой страницы.' }}
    </p>
